...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Tell us your budget, dates, and interests. Get a complete personalized trip itinerary in under 60 seconds." },
      { property: "og:title", content: "TripMind — AI Travel Planner" },
      { property: "og:description", content: "Tell us your budget, dates, and interests. Get a complete personalized trip itinerary in under 60 seconds." },
